...
public class LibrarySim extends Media {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			options.add("Search Books"); // 3
			options.add("Check Out A Book"); // 4
			options.add("Return a Book"); // 5
			options.add("Check Due Date"); // 6
			options.add("Burn A Book"); // 7
			options.add("List All Movies"); // 8
			options.add("Check out a movie"); // 9
			options.add("Return a movie"); //10
			options.add("Quit"); // 11
			int menu = 1;
